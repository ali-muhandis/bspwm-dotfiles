...
Column {
    ...
    Item {
        ...
        Button {
            ...
            text: loggingIn ? "  Logging in..." : (config.TranslateLogin || textConstants.login)
            enabled: !loggingIn && (config.AllowEmptyPassword == "true" || username.text != "" && password.text != "" ? true : false)
            hoverEnabled: true
            ...
            background: Rectangle {
                ...
                opacity: parent.enabled ? 0.8 : 0.2
                radius: config.RoundCorners || 0
            }
